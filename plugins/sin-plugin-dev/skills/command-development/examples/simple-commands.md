...
**Important:** All examples below are written as instructions FOR Sin (agent consumption), not messages TO users. Commands tell Sin what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.sin/commands/review.md`
...
**File:** `.sin/commands/security-review.md`
...
**File:** `.sin/commands/test-file.md`
...
**File:** `.sin/commands/git-status.md`
...
**File:** `.sin/commands/compare-files.md`
...
**File:** `.sin/commands/quick-fix.md`
