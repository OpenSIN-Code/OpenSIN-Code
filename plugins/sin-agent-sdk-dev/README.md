...
A comprehensive plugin for creating and verifying Sin Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new Sin Agent SDK application.
...
- [Agent SDK Overview](https://docs.sin.com/en/api/agent-sdk/overview)
- [TypeScript SDK Reference](https://docs.sin.com/en/api/agent-sdk/typescript)
- [Python SDK Reference](https://docs.sin.com/en/api/agent-sdk/python)
- [Agent SDK Examples](https://docs.sin.com/en/api/agent-sdk/examples)
...
**Issue**: Cannot import from `sin_agent_sdk`

**Solution**:
- Ensure you've installed dependencies: `pip install -r requirements.txt`
- Activate your virtual environment if using one
- Check that the SDK is installed: `pip show sin-agent-sdk`
...
Ashwin Bhat (ashwin@opensin-ai.com)
