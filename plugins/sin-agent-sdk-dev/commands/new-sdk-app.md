---
description: Create and setup a new Sin Agent SDK application
argument-hint: [project-name]
---

You are tasked with helping the user create a new Sin Agent SDK application. Follow these steps carefully:
...
1. **Start with the overview**: https://docs.sin.com/en/api/agent-sdk/overview
2. **Based on the user's language choice, read the appropriate SDK reference**:
   - TypeScript: https://docs.sin.com/en/api/agent-sdk/typescript
   - Python: https://docs.sin.com/en/api/agent-sdk/python
...
2. **Check for Latest Versions**:
   ...
   - For TypeScript: Check https://www.npmjs.com/package/@opensin-ai-ai/sin-agent-sdk
   - For Python: Check https://pypi.org/project/sin-agent-sdk/
...
3. **SDK Installation**:
   ...
   - After installation, verify the installed version:
     ...
     - Python: Run `pip show sin-agent-sdk`
...
5. **Environment setup**:
   ...
   - Explain how to get an API key from https://console.opensin-ai.com/

6. **Optional: Create .sin directory structure**:
   - Offer to create `.sin/` directory for agents, commands, and settings
...
2. **Useful resources**:
   ...
   - Link to TypeScript SDK reference: https://docs.sin.com/en/api/agent-sdk/typescript
   - Link to Python SDK reference: https://docs.sin.com/en/api/agent-sdk/python
