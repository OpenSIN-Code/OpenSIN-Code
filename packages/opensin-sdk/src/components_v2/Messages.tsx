...
import { every } from '../../utils_v2/set.js';
...
import { type AdvisorBlock, isAdvisorBlock } from '../../utils_v2/advisor.js';
import { collapseBackgroundBashNotifications } from '../../utils_v2/collapseBackgroundBashNotifications.js';
import { collapseHookSummaries } from '../../utils_v2/collapseHookSummaries.js';
import { collapseReadSearchGroups } from '../../utils_v2/collapseReadSearch.js';
import { collapseTeammateShutdowns } from '../../utils_v2/collapseTeammateShutdowns.js';
...
import { applyGrouping } from '../../utils_v2/groupToolUses.js';
import { buildMessageLookups, createAssistantMessage, deriveUUID, getMessagesAfterCompactBoundary, getToolUseID, getToolUseIDs, hasUnresolvedHooksFromLookup, isNotEmptyMessage, normalizeMessages, reorderMessagesInUI, type StreamingThinking, type StreamingToolUse, shouldShowUserMessage } from '../../utils_v2/messages.js';
...
const MessagesImpl = ({
  ...
  const disableVirtualScroll = useMemo(() => isEnvTruthy(process.env.OPENSIN_CODE_DISABLE_VIRTUAL_SCROLL), []);
