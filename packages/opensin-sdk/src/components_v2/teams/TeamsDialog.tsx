...
import { getNextPermissionMode } from '../../utils_v2/permissions/getNextPermissionMode.js';
import { getModeColor, type PermissionMode, permissionModeFromString, permissionModeSymbol } from '../../utils_v2/permissions/PermissionMode.js';
import { jsonStringify } from '../../utils_v2/slowOperations.js';
import { IT2_COMMAND, isInsideTmuxSync } from '../../utils_v2/swarm/backends/detection.js';
import { ensureBackendsRegistered, getBackendByType, getCachedBackend } from '../../utils_v2/swarm/backends/registry.js';
import type { PaneBackendType } from '../../utils_v2/swarm/backends/types.js';
import { getSwarmSocketName, TMUX_COMMAND } from '../../utils_v2/swarm/constants.js';
import { addHiddenPaneId, removeHiddenPaneId, removeMemberFromTeam, setMemberMode, setMultipleMemberModes } from '../../utils_v2/swarm/teamHelpers.js';
import { listTasks, type Task, unassignTeammateTasks } from '../../utils_v2/tasks.js';
import { getTeammateStatuses, type TeammateStatus, type TeamSummary } from '../../utils_v2/teamDiscovery.js';
import { createModeSetRequestMessage, sendShutdownRequestToMailbox, writeToMailbox } from '../../utils_v2/teammateMailbox.js';
