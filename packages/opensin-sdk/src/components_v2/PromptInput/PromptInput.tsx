...
import { type IDEAtMentioned, useIdeAtMentioned } from '../../hooks_v2/useIdeAtMentioned.js';
...
import { isQueuedCommandEditable, popAllEditable } from '../../utils_v2/messageQueueManager.js';
...
import { type Command, hasCommand } from '../../commands_v2/index.js';
...
import type { VerificationStatus } from '../../hooks_v2/useApiKeyVerification.js';
import { type HistoryMode, useArrowKeyHistory } from '../../hooks_v2/useArrowKeyHistory.js';
import { useDoublePress } from '../../hooks_v2/useDoublePress.js';
import { useHistorySearch } from '../../hooks_v2/useHistorySearch.js';
import type { IDESelection } from '../../hooks_v2/useIdeSelection.js';
import { useInputBuffer } from '../../hooks_v2/useInputBuffer.js';
import { useMainLoopModel } from '../../hooks_v2/useMainLoopModel.js';
import { usePromptSuggestion } from '../../hooks_v2/usePromptSuggestion.js';
import { useTerminalSize } from '../../hooks_v2/useTerminalSize.js';
import { useTypeahead } from '../../hooks_v2/useTypeahead.js';
import type { BorderTextOptions } from '../../ink/render-border.js';
import { stringWidth } from '../../ink/stringWidth.js';
import { Box, type ClickEvent, type Key, Text, useInput } from '../../ink_v2/index.js';
import { useOptionalKeybindingContext } from '../../keybindings_v2/KeybindingContext.js';
...
import { getGlobalConfig, type PastedContent, saveGlobalConfig } from '../../utils_v2/config.js';
import { logForDebugging } from '../../utils_v2/debug.js';
import { parseDirectMemberMessage, sendDirectMemberMessage } from '../../utils_v2/directMemberMessage.js';
...
import { getFastModeUnavailableReason, isFastModeAvailable, isFastModeCooldown, isFastModeEnabled, isFastModeSupportedByModel } from '../../utils_v2/fastMode.js';
import { isFullscreenEnvEnabled } from '../../utils_v2/fullscreen.js';
import type { PromptInputHelpers } from '../../utils_v2/handlePromptSubmit.js';
import { getImageFromClipboard, PASTE_THRESHOLD } from '../../utils_v2/imagePaste.js';
import type { ImageDimensions } from '../../utils_v2/imageResizer.js';
import { cacheImagePath, storeImage } from '../../utils_v2/imageStore.js';
import { isMacosOptionChar, MACOS_OPTION_SPECIAL_CHARS } from '../../utils_v2/keyboardShortcuts.js';
import { logError } from '../../utils_v2/log.js';
import { isOpus1mMergeEnabled, modelDisplayString } from '../../utils_v2/model/model.js';
import { setAutoModeActive } from '../../utils_v2/permissions/autoModeState.js';
import { cyclePermissionMode, getNextPermissionMode } from '../../utils_v2/permissions/getNextPermissionMode.js';
import { transitionPermissionMode } from '../../utils_v2/permissions/permissionSetup.js';
import { getPlatform } from '../../utils_v2/platform.js';
import type { ProcessUserInputContext } from '../../utils_v2/processUserInput/processUserInput.js';
import { editPromptInEditor } from '../../utils_v2/promptEditor.js';
import { hasAutoModeOptIn } from '../../utils_v2/settings/settings.js';
import { findBtwTriggerPositions } from '../../utils_v2/sideQuestion.js';
import { findSlashCommandPositions } from '../../utils_v2/suggestions/commandSuggestions.js';
import { findSlackChannelPositions, getKnownChannelsVersion, hasSlackMcpServer, subscribeKnownChannels } from '../../utils_v2/suggestions/slackChannelSuggestions.js';
import { isInProcessEnabled } from '../../utils_v2/swarm/backends/registry.js';
import { syncTeammateMode } from '../../utils_v2/swarm/teamHelpers.js';
import type { TeamSummary } from '../../utils_v2/teamDiscovery.js';
import { getTeammateColor } from '../../utils_v2/teammate.js';
...
import { findTokenBudgetPositions } from '../../utils_v2/tokenBudget.js';
import { findUltraplanTriggerPositions, findUltrareviewTriggerPositions } from '../../utils_v2/ultraplan/keyword.js';
  ...
  useEffect(() => {
    if (feature('ULTRAPLAN') && ultraplanTriggers.length) {
      addNotification({
        ...
        text: 'This prompt will launch an ultraplan session in OpenSIN Code on the web',
        priority: 'immediate',
        timeoutMs: 5000
      });
    } else {
  ...
  useEffect(() => {
    if (isUltrareviewEnabled() && ultrareviewTriggers.length) {
      addNotification({
        ...
        text: 'Run /ultrareview after OpenSIN finishes to review these changes in the cloud',
        priority: 'immediate',
        timeoutMs: 5000
      });
    }
