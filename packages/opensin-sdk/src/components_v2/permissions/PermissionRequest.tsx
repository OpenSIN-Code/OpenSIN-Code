...
function getNotificationMessage(toolUseConfirm: ToolUseConfirm): string {
  ...
  if (toolUseConfirm.tool === ExitPlanModeV2Tool) {
    return 'OpenSIN Code needs your approval for the plan';
  }
  if (toolUseConfirm.tool === EnterPlanModeTool) {
    return 'OpenSIN Code wants to enter plan mode';
  }
  if (feature('REVIEW_ARTIFACT') && toolUseConfirm.tool === ReviewArtifactTool) {
    return 'OpenSIN needs your approval for a review artifact';
  }
  if (!toolName || toolName.trim() === '') {
    return 'OpenSIN Code needs your attention';
  }
  return `OpenSIN needs your permission to use ${toolName}`;
}
