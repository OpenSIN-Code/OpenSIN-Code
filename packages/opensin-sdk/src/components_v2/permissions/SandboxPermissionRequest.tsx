...
import { type NetworkHostPattern, shouldAllowManagedSandboxDomainsOnly } from '../../utils_v2/sandbox/sandbox-adapter.js';
...
export function SandboxPermissionRequest(t0) {
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = {
      label: <Text>No, and tell OpenSIN what to do differently <Text bold={true}>(esc)</Text></Text>,
      value: "no"
    };
    $[6] = t6;
  } else {
