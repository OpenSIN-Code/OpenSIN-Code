...
import { useMinDisplayTime } from '../../hooks_v2/useMinDisplayTime.js';
import { Ansi, Box, Text, useTheme } from '../../ink_v2/index.js';
...
import { getToolUseIdsFromCollapsedGroup } from '../../utils_v2/collapseReadSearch.js';
import { getDisplayPath } from '../../utils_v2/file.js';
import { formatDuration, formatSecondsShort } from '../../utils_v2/format.js';
import { isFullscreenEnvEnabled } from '../../utils_v2/fullscreen.js';
import type { buildMessageLookups } from '../../utils_v2/messages.js';
...
export function CollapsedReadSearchContent({
  ...
  if (mcpCallCount > 0) {
    const serverLabel = message.mcpServerNames?.map(n => n.replace(/^opensin\.ai /, '')).join(', ') || 'MCP';
