...
import { Box, NoSelect, Text } from '../../ink_v2/index.js';
...
import { isEmptyMessageText, NO_RESPONSE_REQUESTED } from '../../utils_v2/messages.js';
import { getUpgradeMessage } from '../../utils_v2/model/contextWindowUpgradeCheck.js';
import { getDefaultSonnetModel, renderModelName } from '../../utils_v2/model/model.js';
import { isMacOsKeychainLocked } from '../../utils_v2/secureStorage/macOsKeychainStorage.js';
    ...
    case CREDIT_BALANCE_TOO_LOW_ERROR_MESSAGE:
      {
        ...
        if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
          t2 = <MessageResponse height={1}><Text color="error">Credit balance too low · Add funds: https://platform.opensin.com/settings/billing</Text></MessageResponse>;
          $[5] = t2;
        } else {
          t2 = $[5];
        }
