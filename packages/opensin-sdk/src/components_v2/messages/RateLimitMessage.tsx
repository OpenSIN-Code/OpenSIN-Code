...
export function RateLimitMessage(t0) {
  ...
  const isMax20x = rateLimitTier === "default_opensin_max_20x";
  let t3;
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = shouldProcessMockLimits() || isOpenSINAISubscriber();
    $[2] = t3;
  } else {
    t3 = $[2];
  }
  ...
  const isCurrentlyRateLimited = opensinAiLimits.status === "rejected" && opensinAiLimits.resetsAt !== undefined && !opensinAiLimits.isUsingOverage;
  ...
  bb0: {
    ...
    if ($[7] !== shouldAutoOpenRateLimitOptionsMenu) {
      t7 = getUpsellMessage({
        ...
        isTeamOrEnterprise,
        hasBillingAccess: hasOpenSINAiBillingAccess()
      });
