...
// (e.g. `cat 11k-line-file | opensin`) creates a single user message whose
...
// Head+tail because `{ cat file; echo prompt; } | opensin` puts the user's
...
export function UserPromptMessage({
  ...
  // biome-ignore lint/correctness/useHookAtTopLevel: feature() is a compile-time constant
  useMemo(() => isEnvTruthy(process.env.OPENSIN_CODE_BRIEF), []) : false;
