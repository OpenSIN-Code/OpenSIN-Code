...
import { useClipboardImageHint } from '../../hooks_v2/useClipboardImageHint.js';
import { useSettings } from '../../hooks_v2/useSettings.js';
import { useTextInput } from '../../hooks_v2/useTextInput.js';
import { Box, color, useAnimationFrame, useTerminalFocus, useTheme } from '../../ink_v2/index.js';
...
export default function TextInput(props: Props): React.ReactNode {
  ...
  const accessibilityEnabled = useMemo(() => isEnvTruthy(process.env.OPENSIN_CODE_ACCESSIBILITY), []);
