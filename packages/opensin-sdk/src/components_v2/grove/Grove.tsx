...
import { Box, Link, Text, useInput } from '../../ink_v2/index.js';
...
function GracePeriodContentBody() {
  ...
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Text>· </Text>;
    t3 = <Text bold={true}>You can help improve OpenSIN </Text>;
    $[2] = t2;
    $[3] = t3;
  } else {
    t2 = $[2];
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box paddingLeft={1}><Text>{t2}{t3}<Text>— Allow the use of your chats and coding sessions to train and improve Opensin AI models. Change anytime in your Privacy Settings (<Link url="https://opensin.ai/settings/data-privacy-controls" />).</Text></Text></Box>;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Link url="https://www.opensin.com/news/updates-to-our-consumer-terms" />;
    $[6] = t6;
  } else {
    t6 = $[6];
  }
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Link url="https://opensin.com/legal/terms" />;
    $[7] = t7;
  } else {
    t7 = $[7];
  }
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <>{t0}{t5}<Text>Learn more ({t6}) or read the updated Consumer Terms ({t7}) and Privacy Policy (<Link url="https://opensin.com/legal/privacy" />)</Text></>;
    $[8] = t8;
  } else {
    t8 = $[8];
  }
...
function PostGracePeriodContentBody() {
  ...
  let t2;
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Box flexDirection="column"><Text bold={true}>Help improve OpenSIN</Text><Text>Allow the use of your chats and coding sessions to train and improve Opensin AI models. You can change this anytime in Privacy Settings</Text><Link url="https://opensin.ai/settings/data-privacy-controls" /></Box>;
    $[2] = t2;
  } else {
    t2 = $[2];
  }
  ...
  if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box flexDirection="column" gap={1}>{t1}{t2}<Box flexDirection="column"><Text bold={true}>How this affects data retention</Text><Text>Turning ON the improve OpenSIN setting extends data retention from 30 days to 5 years. Turning it OFF keeps the default 30-day data retention. Delete data anytime.</Text></Box></Box>;
    $[3] = t3;
  } else {
    t3 = $[3];
  }
  let t4;
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Link url="https://www.opensin.com/news/updates-to-our-consumer-terms" />;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
  let t5;
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Link url="https://opensin.com/legal/terms" />;
    $[5] = t5;
  } else {
    t5 = $[5];
  }
  let t6;
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <>{t0}{t3}<Text>Learn more ({t4}) or read the updated Consumer Terms ({t5}) and Privacy Policy (<Link url="https://opensin.com/legal/privacy" />)</Text></>;
    $[6] = t6;
  } else {
    t6 = $[6];
  }
...
export function GroveDialog(t0) {
  ...
  if ($[8] !== groveConfig?.domain_excluded) {
    t4 = groveConfig?.domain_excluded ? [{
      label: "Accept terms \xB7 Help improve OpenSIN: OFF (for emails with your domain)",
      value: "accept_opt_out"
    }] : [{
      label: "Accept terms \xB7 Help improve OpenSIN: ON",
      value: "accept_opt_in"
    }, {
      label: "Accept terms \xB7 Help improve OpenSIN: OFF",
      value: "accept_opt_out"
    }];
...
export function PrivacySettingsDialog(t0) {
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text>Review and manage your privacy settings at{" "}<Link url="https://opensin.ai/settings/data-privacy-controls" /></Text>;
    $[9] = t5;
  } else {
    t5 = $[9];
  }
  ...
  if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box width={44}><Text bold={true}>Help improve OpenSIN</Text></Box>;
    $[10] = t6;
  } else {
    t6 = $[10];
  }
