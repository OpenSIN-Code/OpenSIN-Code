...
import { Box, Link, Newline, Text, useTheme } from '../../ink_v2/index.js';
...
import { getCustomApiKeyStatus } from '../../utils_v2/config.js';
import { env } from '../../utils_v2/env.js';
import { isRunningOnHomespace } from '../../utils_v2/envUtils.js';
import { PreflightStep } from '../../utils_v2/preflightChecks.js';
import type { ThemeSetting } from '../../utils_v2/theme.js';
...
export function Onboarding({
  ...
  const [oauthEnabled] = useState(() => isOpenSINAuthEnabled());
  ...
  const securityStep = <Box flexDirection="column" gap={1} paddingLeft={1}>
      ...
      <Box flexDirection="column" width={70}>
        ...
        <OrderedList>
          <OrderedList.Item>
            <Text>OpenSIN can make mistakes</Text>
            <Text dimColor wrap="wrap">
              You should always review OpenSIN&apos;s responses, especially when
              <Newline />
              running code.
              <Newline />
            </Text>
          ...
          <OrderedList.Item>
            ...
            <Text dimColor wrap="wrap">
              ...
              <Newline />
              <Link url="https://code.opensin.com/docs/en/security" />
            </Text>
          </OrderedList.Item>
        </OrderedList>
      </Box>
  ...
  const apiKeyNeedingApproval = useMemo(() => {
    ...
    if (!process.env.OPENSIN_API_KEY || isRunningOnHomespace()) {
      return '';
    }
    const customApiKeyTruncated = normalizeApiKeyForConfig(process.env.OPENSIN_API_KEY);
  ...
  if (shouldOfferTerminalSetup()) {
    steps.push({
      ...
      component: <Box flexDirection="column" gap={1} paddingLeft={1}>
          <Text bold>Use OpenSIN Code&apos;s terminal setup?</Text>
