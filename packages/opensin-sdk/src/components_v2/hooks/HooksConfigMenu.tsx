 ...
 * or ask OpenSIN — the menu directs them there.
 *
...
import { useSettingsChange } from '../../hooks_v2/useSettingsChange.js';
import { Box, Text } from '../../ink_v2/index.js';
import { useKeybinding } from '../../keybindings_v2/useKeybinding.js';
import { getHookEventMetadata, getHooksForMatcher, getMatcherMetadata, getSortedMatchersForEvent, groupHooksByEventAndMatcher } from '../../utils_v2/hooks/hooksConfigManager.js';
import type { IndividualHookConfig } from '../../utils_v2/hooks/hooksSettings.js';
import { getSettings_DEPRECATED, getSettingsForSource } from '../../utils_v2/settings/settings.js';
...
export function HooksConfigMenu(t0) {
  ...
  if (hooksDisabled_1) {
    ...
    if ($[53] !== disabledByPolicy) {
      t32 = !disabledByPolicy && <Text dimColor={true}>To re-enable hooks, remove "disableAllHooks" from settings.json or ask OpenSIN.</Text>;
      $[53] = disabledByPolicy;
      $[54] = t32;
    } else {
      t32 = $[54];
