...
// event/notch — users on those can set OPENSIN_CODE_SCROLL_SPEED=3 to match
...
/** Read OPENSIN_CODE_SCROLL_SPEED, default 1, clamp (0, 20].
 ...
 *  set OPENSIN_CODE_SCROLL_SPEED=3 to match vim/nvim/opencode. We can't
...
export function readScrollSpeedBase(): number {
  const raw = process.env.OPENSIN_CODE_SCROLL_SPEED;
  if (!raw) return 1;
...
export function ScrollKeybindingHandler({
  ...
  // opensin/jump-recent-message-CEPcq). getItemY Yoga-walk + computeOrigin +
