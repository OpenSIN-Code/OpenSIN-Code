...
import { isChromeExtensionInstalled, shouldEnableOpenSINInChrome } from '../../utils_v2/opensinInChrome/setup.js';
...
async function _temp() {
  ...
  if (!shouldEnableOpenSINInChrome(chromeFlag)) {
    return null;
  }
  if (true && !isOpenSINAISubscriber()) {
    return {
      key: "chrome-requires-subscription",
      jsx: <Text color="error">OpenSIN in Chrome requires a opensin.ai subscription</Text>,
      priority: "immediate",
      timeoutMs: 5000
    };
  }
  ...
  if (!installed && !isRunningOnHomespace()) {
    return {
      ...
      jsx: <Text color="warning">Chrome extension not detected · https://opensin.ai/chrome to install</Text>,
      priority: "immediate",
      timeoutMs: 3000
    };
  }
  if (chromeFlag === undefined) {
    return {
      key: "opensin-in-chrome-default-enabled",
      text: "OpenSIN in Chrome enabled \xB7 /chrome",
      priority: "low"
    };
  }
  return null;
