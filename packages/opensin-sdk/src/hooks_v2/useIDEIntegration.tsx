...
import type { DetectedIDEInfo } from '../../utils_v2/ide.js';
import { type IDEExtensionInstallationStatus, type IdeType, initializeIdeIntegration, isSupportedTerminal } from '../../utils_v2/ide.js';
  ...
  if ($[0] !== autoConnectIdeFlag || $[1] !== ideToInstallExtension || $[2] !== setDynamicMcpConfig || $[3] !== setIDEInstallationState || $[4] !== setShowIdeOnboarding) {
    t1 = () => {
      const addIde = function addIde(ide) {
        ...
        const autoConnectEnabled = (globalConfig.autoConnectIde || autoConnectIdeFlag || isSupportedTerminal() || process.env.OPENSIN_CODE_SSE_PORT || ideToInstallExtension || isEnvTruthy(process.env.OPENSIN_CODE_AUTO_CONNECT_IDE)) && !isEnvDefinedFalsy(process.env.OPENSIN_CODE_AUTO_CONNECT_IDE);
