...
import { type Command, getCommandName } from '../../commands_v2/index.js';
import { getModeFromInput, getValueFromInput } from '../../components_v2/PromptInput/inputModes.js';
import type { SuggestionItem, SuggestionType } from '../../components_v2/PromptInput/PromptInputFooterSuggestions.js';
...
import { useOptionalKeybindingContext, useRegisterKeybindingContext } from '../../keybindings_v2/KeybindingContext.js';
...
import { generateProgressiveArgumentHint, parseArguments } from '../../utils_v2/argumentSubstitution.js';
import { getShellCompletions, type ShellCompletionType } from '../../utils_v2/bash/shellCompletion.js';
import { formatLogMetadata } from '../../utils_v2/format.js';
import { getSessionIdFromLog, searchSessionsByCustomTitle } from '../../utils_v2/sessionStorage.js';
import { applyCommandSuggestion, findMidInputSlashCommand, generateCommandSuggestions, getBestCommandMatch, isCommandInput } from '../../utils_v2/suggestions/commandSuggestions.js';
import { getDirectoryCompletions, getPathCompletions, isPathLikeToken } from '../../utils_v2/suggestions/directoryCompletion.js';
import { getShellHistoryCompletion } from '../../utils_v2/suggestions/shellHistoryCompletion.js';
import { getSlackChannelSuggestions, hasSlackMcpServer } from '../../utils_v2/suggestions/slackChannelSuggestions.js';
