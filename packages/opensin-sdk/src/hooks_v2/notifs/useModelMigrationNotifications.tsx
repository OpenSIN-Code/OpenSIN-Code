...
import { type GlobalConfig, getGlobalConfig } from '../../utils_v2/config.js';
...
c => {
  ...
  return {
    key: 'opus-pro-update',
    text: isLegacyRemap ? 'Model updated to Opus 4.6 · Set OPENSIN_CODE_DISABLE_LEGACY_MODEL_REMAP=1 to opt out' : 'Model updated to Opus 4.6',
    color: 'suggestion',
    priority: 'high',
