...
/**
 * Surfaces plugin-install prompts driven by `<opensin-code-hint />` tags
 * that CLIs/SDKs emit to stderr. See docs/opensin-code-hints.md.
 *
...
export function useOpenSINCodeHintRecommendation() {
  const $ = _c(11);
  ...
  if ($[0] !== pendingHint || $[1] !== tryResolve) {
    t0 = () => {
      ...
      tryResolve(async () => {
        ...
        if (resolved) {
          logForDebugging(`[useOpenSINCodeHintRecommendation] surfacing ${resolved.pluginId} from ${resolved.sourceCommand}`);
