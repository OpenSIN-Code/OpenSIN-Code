...
import { ExitFlow } from '../../components_v2/ExitFlow.js';
import type { LocalJSXCommandOnDone } from '../../types/command.js';
import { isBgSession } from '../../utils_v2/concurrentSessions.js';
...
export async function call(onDone: LocalJSXCommandOnDone): Promise<React.ReactNode> {
  // Inside a `opensin --bg` tmux session: detach instead of kill. The REPL
  // keeps running; `opensin attach` can reconnect. Covers /exit, /quit,
