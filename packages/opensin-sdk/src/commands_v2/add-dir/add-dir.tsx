...
import { getAdditionalDirectoriesForOpenSINMd, setAdditionalDirectoriesForOpenSINMd } from '../../bootstrap_system/state.js';
import type { LocalJSXCommandContext } from '../../commands_v2/index.js';
import { MessageResponse } from '../../components_v2/MessageResponse.js';
import { AddWorkspaceDirectory } from '../../components_v2/permissions/rules/AddWorkspaceDirectory.js';
...
export async function call(onDone: LocalJSXCommandOnDone, context: LocalJSXCommandContext, args?: string): Promise<React.ReactNode> {
  ...
  const handleAddDirectory = async (path: string, remember = false) => {
    ...
    const currentDirs = getAdditionalDirectoriesForOpenSINMd();
    if (!currentDirs.includes(path)) {
      setAdditionalDirectoriesForOpenSINMd([...currentDirs, path]);
    }
