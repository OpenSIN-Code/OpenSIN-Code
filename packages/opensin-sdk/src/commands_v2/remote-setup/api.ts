 ...
 * clone/push in opensin.ai/code works immediately after this succeeds.
 */
...
/** Returns true when the user has valid OpenSIN OAuth credentials. */
...
export function getCodeWebUrl(): string {
  return `${getOauthConfig().OPENSIN_AI_ORIGIN}/code`
}
