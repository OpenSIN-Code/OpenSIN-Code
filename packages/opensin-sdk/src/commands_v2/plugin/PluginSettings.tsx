...
import { Tab, Tabs } from '../../components_v2/design-system/Tabs.js';
...
import { loadMarketplacesWithGracefulDegradation } from '../../utils_v2/plugins/marketplaceHelpers.js';
import { loadKnownMarketplacesConfig, removeMarketplaceSource } from '../../utils_v2/plugins/marketplaceManager.js';
import { getPluginEditableScopes } from '../../utils_v2/plugins/pluginStartupCheck.js';
import type { EditableSettingSource } from '../../utils_v2/settings/constants.js';
...
function ErrorsTabContent(t0) {
  ...
  let t13;
  if ($[13] !== actionMessage) {
    t13 = actionMessage && <Box marginTop={1} marginLeft={1}><Text color="opensin">{actionMessage}</Text></Box>;
    $[13] = actionMessage;
    $[14] = t13;
  } else {
    t13 = $[14];
