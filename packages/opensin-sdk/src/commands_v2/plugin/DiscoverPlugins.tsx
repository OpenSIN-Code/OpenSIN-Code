...
import { formatInstallCount, getInstallCounts } from '../../utils_v2/plugins/installCounts.js';
import { isPluginGloballyInstalled } from '../../utils_v2/plugins/installedPluginsManager.js';
import { createPluginId, detectEmptyMarketplaceReason, type EmptyMarketplaceReason, formatFailureDetails, formatMarketplaceLoadingErrors, loadMarketplacesWithGracefulDegradation } from '../../utils_v2/plugins/marketplaceHelpers.js';
import { loadKnownMarketplacesConfig } from '../../utils_v2/plugins/marketplaceManager.js';
...
import { truncateToWidth } from '../../utils_v2/truncate.js';
    ...
    case "git-not-installed":
      {
        ...
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
          t1 = <><Text dimColor={true}>Git is required to install marketplaces.</Text><Text dimColor={true}>Please install git and restart OpenSIN Code.</Text></>;
          $[0] = t1;
        } else {
          t1 = $[0];
        }
