...
import { isPluginGloballyInstalled, isPluginInstalled } from '../../utils_v2/plugins/installedPluginsManager.js';
import { createPluginId, formatFailureDetails, formatMarketplaceLoadingErrors, getMarketplaceSourceDisplay, loadMarketplacesWithGracefulDegradation } from '../../utils_v2/plugins/marketplaceHelpers.js';
import { getMarketplace, loadKnownMarketplacesConfig } from '../../utils_v2/plugins/marketplaceManager.js';
  ...
  useEffect(() => {
    async function loadMarketplaceData() {
      try {
        ...
        // Sort so opensin-plugin-directory is always first
