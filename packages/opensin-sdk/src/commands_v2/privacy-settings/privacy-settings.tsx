...
import { type GroveDecision, GroveDialog, PrivacySettingsDialog } from '../../components_v2/grove/Grove.js';
...
const FALLBACK_MESSAGE = 'Review and manage your privacy settings at https://opensin.ai/settings/data-privacy-controls';
export async function call(onDone: LocalJSXCommandOnDone): Promise<React.ReactNode | null> {
  ...
  async function onDoneWithSettingsCheck() {
    ...
    onDone(`"Help improve OpenSIN" set to ${groveStatus}.`);
