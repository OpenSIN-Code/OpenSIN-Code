...
import { backupTerminalPreferences, checkAndRestoreTerminalBackup, getTerminalPlistPath, markTerminalSetupComplete } from '../../utils_v2/appleTerminalBackup.js';
import { setupShellCompletion } from '../../utils_v2/completionCache.js';
...
import { addItemToJSONCArray, safeParseJSONC } from '../../utils_v2/json.js';
 ...
 * not the remote server where OpenSIN is running.
 */
...
export function shouldOfferTerminalSetup(): boolean {
  ...
  // keyboard protocol, which OpenSIN Code already parses. No setup needed for
  // these terminals.
