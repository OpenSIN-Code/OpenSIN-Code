...
import { shouldUseOpenSINAIAuth } from './client.js'
...
export class AuthCodeListener {
  ...
  handleSuccessRedirect(
    ...
    const successUrl = shouldUseOpenSINAIAuth(scopes)
      ? getOauthConfig().OPENSINAI_SUCCESS_URL
  ...
  handleErrorRedirect(): void {
    ...
    const errorUrl = getOauthConfig().OPENSINAI_SUCCESS_URL
