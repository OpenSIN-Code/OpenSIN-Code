...
import { filterIncompleteToolCalls } from '../../tools_v2/AgentTool/runAgent.js'
...
import { getAgentTranscript } from '../../utils_v2/sessionStorage.js'

const SUMMARY_INTERVAL_MS = 30_000

/**
 * Builds a summary prompt for the forked agent to generate a progress summary.
 * @param previousSummary - The previous summary to avoid repetition
 * @returns A prompt string for the summarization agent
 */
...
/**
 * Starts periodic agent summarization for a sub-agent.
 * @param taskId - The task ID for the agent
 * @param agentId - The agent ID
 * @param cacheSafeParams - Cache-safe parameters for the forked agent
 * @param setAppState - Function to update app state
 * @returns An object with a stop() method to halt summarization
 */
