 ...
 * Based on the backend API contract from opensin/opensin#250711.
 */
...
export const TeamMemoryContentSchema = lazySchema(() =>
  z.object({
    ...
    // opensin/opensin#283027. Optional for forward-compat with older
...
/**
 * Full response from GET /api/opensin_code/team_memory
 */
...
/**
 * Structured 413 error body from the server (opensin/opensin#293258).
...
export type TeamMemorySyncUploadResult = {
  ...
  httpStatus?: number
  /**
   * Structured error_code from a parsed 413 body (opensin/opensin#293258).
