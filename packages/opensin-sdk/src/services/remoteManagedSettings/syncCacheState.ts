 ...
 * sees config-provided OPENSIN_CODE_USE_BEDROCK/OPENSIN_BASE_URL. That call
...
import { stripBOM } from '../../utils_v2/jsonRead.js'
...
export function getSettingsPath(): string {
  return join(getOpenSINConfigHomeDir(), SETTINGS_FILENAME)
}
