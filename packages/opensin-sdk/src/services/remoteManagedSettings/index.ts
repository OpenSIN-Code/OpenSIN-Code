 ...
 * - OAuth users (OpenSIN.ai): Only Enterprise/C4E and Team subscribers are eligible
...
import { classifyAxiosError, getErrnoCode } from '../../utils_v2/errors.js'
...
function getRemoteManagedSettingsEndpoint() {
  return `${getOauthConfig().BASE_API_URL}/api/opensin_code/settings`
}
