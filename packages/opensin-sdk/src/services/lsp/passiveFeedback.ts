...
/**
 * Map LSP severity to OpenSIN diagnostic severity
 *
 * Maps LSP severity numbers to OpenSIN diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to OpenSIN diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by OpenSIN's attachment system.
 */
 ...
 * from all LSP servers and routes them to OpenSIN's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to OpenSIN format (can throw on invalid URIs)
