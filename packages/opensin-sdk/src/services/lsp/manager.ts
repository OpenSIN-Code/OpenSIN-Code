...
import { isBareMode } from '../../utils_v2/envUtils.js'
 ...
 * Initialized during OpenSIN Code startup.
 */
 ...
 * asynchronously during OpenSIN Code startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during OpenSIN Code startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/opensins/opensin-code/issues/15521:
 ...
 *
 * This should be called during OpenSIN Code shutdown. Stops all running LSP servers
