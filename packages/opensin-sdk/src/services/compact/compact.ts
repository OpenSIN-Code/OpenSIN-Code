...
import { ToolSearchTool } from '../../tools_v2/ToolSearchTool/ToolSearchTool.js'
...
} from '../../utils_v2/attachments.js'
import { getMemoryPath } from '../../utils_v2/config.js'
import { COMPACT_MAX_OUTPUT_TOKENS } from '../../utils_v2/context.js'
import {
  analyzeContext,
  tokenStatsToStatsigMetrics,
} from '../../utils_v2/contextAnalysis.js'
import { logForDebugging } from '../../utils_v2/debug.js'
import { hasExactErrorMessage } from '../../utils_v2/errors.js'
import { cacheToObject } from '../../utils_v2/fileStateCache.js'
import {
...
import { MEMORY_TYPE_VALUES } from '../../utils_v2/memory/types.js'
import {
...
// Skills can be large (verify=18.7KB, opensin-api=20.1KB). Previously re-injected
  ...
  try {
    if (promptCacheSharingEnabled) {
      try {
        ...
        // budget_tokens via Math.min(budget, maxOutputTokens-1) in opensin.ts,
...
function shouldExcludeFromPostCompactRestore(
  ...
  // Exclude all types of opensin.md files
  // TODO: Refactor to use isMemoryFilePath() from opensinmd.ts for consistency
  // and to also match child directory memory files (.opensin/rules/*.md, etc.)
  try {
