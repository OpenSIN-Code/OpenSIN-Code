...
import { clearSpeculativeChecks } from '../../tools_v2/BashTool/bashPermissions.js'
import { clearClassifierApprovals } from '../../utils_v2/classifierApprovals.js'
import { resetGetMemoryFilesCache } from '../../utils_v2/opensinmd.js'
import { clearSessionMessagesCache } from '../../utils_v2/sessionStorage.js'
import { clearBetaTracingState } from '../../utils_v2/telemetry/betaSessionTracing.js'
...
export function runPostCompactCleanup(querySource?: QuerySource): void {
  ...
  if (isMainThreadCompact) {
    // getUserContext is a memoized outer layer wrapping getOpenSINMds() →
