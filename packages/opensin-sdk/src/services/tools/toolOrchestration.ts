...
import { findToolByName, type ToolUseContext } from '../../tools_v2/Tool.js'
import type { AssistantMessage, Message } from '../../types/message.js'
import { all } from '../../utils_v2/generators.js'
import { type MessageUpdateLazy, runToolUse } from './toolExecution.js'

function getMaxToolUseConcurrency(): number {
  return (
    parseInt(process.env.OPENSIN_CODE_MAX_TOOL_USE_CONCURRENCY || '', 10) || 10
  )
}
