...
- Information already in OPENSIN.md or other project docs
 ...
 * Custom prompts can be placed at ~/.opensin/magic-docs/prompt.md
...
async function loadMagicDocsPrompt(): Promise<string> {
  ...
  const promptPath = join(getOpenSINConfigHomeDir(), 'magic-docs', 'prompt.md')
