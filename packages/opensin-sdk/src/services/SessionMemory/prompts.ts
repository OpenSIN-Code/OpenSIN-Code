...
import { getErrnoCode, toError } from '../../utils_v2/errors.js'
...
Based on the user conversation above (EXCLUDING this note-taking instruction message as well as system prompt, opensin.md entries, or any past session summaries), update the session notes file.
...
- Do not include information that's already in the OPENSIN.md files included in the context
 ...
 * Custom prompts can be placed at ~/.opensin/session-memory/prompt.md
