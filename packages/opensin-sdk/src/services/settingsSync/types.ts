 ...
 * Based on the backend API contract from opensin/opensin#218817.
 */
...
/**
 * Full response from GET /api/opensin_code/user_settings
 */
...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.opensin/settings.json',
  USER_MEMORY: '~/.opensin/OPENSIN.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.opensin/settings.local.json`,
  projectMemory: (projectId: string) => `projects/${projectId}/OPENSIN.local.md`,
} as const
