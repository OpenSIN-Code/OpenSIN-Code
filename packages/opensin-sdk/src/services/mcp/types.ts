...
// Config type for OpenSIN.ai proxy servers
export const McpOpenSINAIProxyServerConfigSchema = lazySchema(() =>
  z.object({
    type: z.literal('opensinai-proxy'),
    url: z.string(),
    id: z.string(),
  }),
)
...
export const McpServerConfigSchema = lazySchema(() =>
  z.union([
    ...
    McpOpenSINAIProxyServerConfigSchema(),
  ]),
)
...
>
export type McpOpenSINAIProxyServerConfig = z.infer<
  ReturnType<typeof McpOpenSINAIProxyServerConfigSchema>
>
...
export type ScopedMcpServerConfig = McpServerConfig & {
  ...
  // (e.g. 'slack@opensin'). Stashed at config-build time so the channel
