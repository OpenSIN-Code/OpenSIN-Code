...
import { getCanonicalName } from '../../utils_v2/model/model.js'
import { getAPIProvider } from '../../utils_v2/model/providers.js'
import { MODEL_COSTS } from '../../utils_v2/modelCost.js'
...
export async function trackDatadogEvent(
  ...
  try {
    ...
    const log: DatadogLog = {
      ...
      ddtags: tags.join(','),
      message: eventName,
      service: 'opensin-code',
      hostname: 'opensin-code',
...
function getFlushIntervalMs(): number {
  ...
  return (
    parseInt(process.env.OPENSIN_CODE_DATADOG_FLUSH_INTERVAL_MS || '', 10) ||
