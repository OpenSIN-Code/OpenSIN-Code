...
import { updateLastInteractionTime } from '../../bootstrap_system/state.js';
import { logForDebugging } from '../../utils_v2/debug.js';
import { stopCapturingEarlyInput } from '../../utils_v2/earlyInput.js';
import { isEnvTruthy } from '../../utils_v2/envUtils.js';
import { isMouseClicksDisabled } from '../../utils_v2/fullscreen.js';
...
export default class App extends PureComponent<Props, State> {
  ...
  override componentDidMount() {
    ...
    if (this.props.stdout.isTTY && !isEnvTruthy(process.env.OPENSIN_CODE_ACCESSIBILITY)) {
  ...
  handleSuspend = (): void => {
    ...
    // Emit suspend event for OpenSIN Code to handle. Mostly just has a notification
    ...
    const resumeHandler = () => {
      ...
      if (this.props.stdout.isTTY) {
        if (!isEnvTruthy(process.env.OPENSIN_CODE_ACCESSIBILITY)) {
          this.props.stdout.write(HIDE_CURSOR);
        }
      ...
      // Emit resume event for OpenSIN Code to handle
