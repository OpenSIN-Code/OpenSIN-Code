...
import { getKairosActive } from '../../bootstrap_system/state.js';
import { TOOL_SUMMARY_MAX_LENGTH } from '../../constants/toolLimits.js';
import { type AnalyticsMetadata_I_VERIFIED_THIS_IS_NOT_CODE_OR_FILEPATHS, logEvent } from '../../services/analytics/index.js';
import { notifyVscodeFileUpdated } from '../../services/mcp/vscodeSdkMcp.js';
import type { SetToolJSXFn, ToolCallProgress, ToolUseContext, ValidationResult } from '../../tools_v2/Tool.js';
import { buildTool, type ToolDef } from '../../tools_v2/Tool.js';
import { backgroundExistingForegroundTask, markTaskNotified, registerForeground, spawnShellTask, unregisterForeground } from '../../tasks/LocalShellTask/LocalShellTask.js';
import type { AgentId } from '../../types/ids.js';
import type { AssistantMessage } from '../../types/message.js';
import { parseForSecurity } from '../../utils_v2/bash/ast.js';
import { splitCommand_DEPRECATED, splitCommandWithOperators } from '../../utils_v2/bash/commands.js';
import { extractOpenSINCodeHints } from '../../utils_v2/opensinCodeHints.js';
import { detectCodeIndexingFromCommand } from '../../utils_v2/codeIndexing.js';
import { isEnvTruthy } from '../../utils_v2/envUtils.js';
import { isENOENT, ShellError } from '../../utils_v2/errors.js';
import { detectFileEncoding, detectLineEndings, getFileModificationTime, writeTextContent } from '../../utils_v2/file.js';
import { fileHistoryEnabled, fileHistoryTrackEdit } from '../../utils_v2/fileHistory.js';
...
import { maybeRecordPluginHint } from '../../utils_v2/plugins/hintRecommendation.js';
import { exec } from '../../utils_v2/Shell.js';
import type { ExecResult } from '../../utils_v2/ShellCommand.js';
...
import { EndTruncatingAccumulator } from '../../utils_v2/stringUtils.js';
import { getTaskOutputPath } from '../../utils_v2/task/diskOutput.js';
import { TaskOutput } from '../../utils_v2/task/TaskOutput.js';
import { isOutputLineTruncated } from '../../utils_v2/terminal.js';
import { buildLargeToolResultMessage, ensureToolResultsDir, generatePreview, getToolResultPath, PREVIEW_SIZE_BYTES } from '../../utils_v2/toolResultStorage.js';
...
isEnvTruthy(process.env.OPENSIN_CODE_DISABLE_BACKGROUND_TASKS);
...
export const BashTool = buildTool({
  ...
  userFacingName(input) {
    ...
    return isEnvTruthy(process.env.OPENSIN_CODE_BASH_SANDBOX_SHOW_INDICATOR) && shouldUseSandbox(input) ? 'SandboxedBash' : 'Bash';
  },
  ...
  mapToolResultToToolResultBlockParam({
    ...
    // For image data, format as image content block for OpenSIN
    if (isImage) {
  ...
  async call(input: BashToolInput, toolUseContext, _canUseTool?: CanUseToolFn, parentMessage?: AssistantMessage, onProgress?: ToolCallProgress<BashProgress>) {
    ...
    // OpenSIN Code hints protocol: CLIs/SDKs gated on OPENSINCODE=1 emit a
    // `<opensin-code-hint />` tag to stderr (merged into stdout here). Scan,
    // record for useOpenSINCodeHintRecommendation to surface, then strip
    // so the model never sees the tag — a zero-token side channel.
    // Stripping runs unconditionally (subagent output must stay clean too);
    // only the dialog recording is main-thread-only.
    const extracted = extractOpenSINCodeHints(strippedStdout, input.command);
...
async function* runShellCommand({
  ...
  // Handle OpenSIN asking to run it in the background explicitly
