...
function getPlanV2SystemPrompt(): string {
  ...
  return `You are a software architect and planning specialist for OpenSIN Code. Your role is to explore the codebase and design implementation plans.
...
export const PLAN_AGENT: BuiltInAgentDefinition = {
  ...
  baseDir: 'built-in',
  model: 'inherit',
  // Plan is read-only and can Read OPENSIN.md directly if it needs conventions.
