import { isPDFSupported } from '../../utils_v2/pdfUtils.js'
...
${offsetInstruction}
${lineFormat}
- This tool allows OpenSIN Code to read images (eg PNG, JPG, etc). When reading an image file the contents are presented visually as OpenSIN Code is a multimodal LLM.${
    isPDFSupported()
