...
export const DESCRIPTION = 'Get or set OpenSIN Code configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set OpenSIN Code configuration settings.

  View or change OpenSIN Code settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.opensin.json)
${globalSettings.join('\n')}
