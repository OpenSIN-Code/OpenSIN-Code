...
import type { SetToolJSXFn, Tool, ToolCallProgress, ValidationResult } from '../../tools_v2/Tool.js';
...
import { errorMessage as getErrorMessage, ShellError } from '../../utils_v2/errors.js';
...
import { getCachedPowerShellPath } from '../../utils_v2/shell/powershellDetection.js';
  ...
  async call(input: PowerShellToolInput, toolUseContext: Parameters<Tool['call']>[1], _canUseTool?: CanUseToolFn, _parentMessage?: AssistantMessage, onProgress?: ToolCallProgress<PowerShellProgress>): Promise<{
    ...
    try {
      ...
      if (result.backgroundTaskId) {
        const bgExtracted = extractOpenSINCodeHints(result.stdout || '', input.command);
      ...
      const extracted = extractOpenSINCodeHints(stdout, input.command);
