...
/**
 * Checks if user needs to log in with OpenSIN.ai
 * Extracted from getTeleportErrors() in TeleportError.tsx
 * @returns true if login is required, false otherwise
 */
export async function checkNeedsOpenSINAiLogin(): Promise<boolean> {
 ...
 * @param owner The repository owner (e.g., "opensins")
 * @param repo The repository name (e.g., "opensin-cli-internal")
