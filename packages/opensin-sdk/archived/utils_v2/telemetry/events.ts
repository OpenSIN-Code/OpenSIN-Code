...
import { getEventLogger, getPromptId } from '../../bootstrap_system/state.js'
...
export async function logOTelEvent(
  ...
  const workspaceDir = process.env.OPENSIN_CODE_WORKSPACE_HOST_PATHS
  if (workspaceDir) {
