...
const TEAMMATE_ENV_VARS = [
  ...
  // its own way via /home/opensin/.opensin/remote/.oauth_token regardless;
  ...
  'OPENSIN_CODE_REMOTE_MEMORY_DIR',
 ...
 * Always includes OPENSINCODE=1 and OPENSIN_CODE_EXPERIMENTAL_AGENT_TEAMS=1,
 * plus any provider/config env vars that are set in the current process.
 */
export function buildInheritedEnvVars(): string {
  const envVars = ['OPENSINCODE=1', 'OPENSIN_CODE_EXPERIMENTAL_AGENT_TEAMS=1']
