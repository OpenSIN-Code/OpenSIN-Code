...
export function fileHistoryEnabled(): boolean {
  ...
  return (
    ...
    !isEnvTruthy(process.env.OPENSIN_CODE_DISABLE_FILE_CHECKPOINTING)
  )
}

function fileHistoryEnabledSdk(): boolean {
  return (
    isEnvTruthy(process.env.OPENSIN_CODE_ENABLE_SDK_FILE_CHECKPOINTING) &&
    !isEnvTruthy(process.env.OPENSIN_CODE_DISABLE_FILE_CHECKPOINTING)
  )
}
...
export async function fileHistoryMakeSnapshot(
  ...
  // for any wrapper that honors same-ref returns (src/OPENSIN.md wrapper
