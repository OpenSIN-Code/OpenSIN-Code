import { getAllowedSettingSources } from '../../bootstrap_system/state.js'
...
/**
 * The JSON Schema URL for OpenSIN Code settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/opensin-code-settings.json
 */
export const OPENSIN_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/opensin-code-settings.json'
