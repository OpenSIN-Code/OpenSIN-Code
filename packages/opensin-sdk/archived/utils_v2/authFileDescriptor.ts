 ...
 * /home/opensin/.opensin/remote/ and will (eventually) write these files too.
 ...
 */
const CCR_TOKEN_DIR = '/home/opensin/.opensin/remote'
 ...
 * access. CCR-gated: outside CCR there's no /home/opensin/ and no reason to
...
export function maybePersistTokenForSubprocesses(
  ...
  if (!isEnvTruthy(process.env.OPENSIN_CODE_REMOTE)) {
    return
  }
  try {
 ...
 * rationale. Env var: OPENSIN_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR.
 * Well-known file: /home/opensin/.opensin/remote/.oauth_token.
 */
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'OPENSIN_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR',
 ...
 * rationale. Env var: OPENSIN_CODE_API_KEY_FILE_DESCRIPTOR.
 * Well-known file: /home/opensin/.opensin/remote/.api_key.
 */
export function getApiKeyFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'OPENSIN_CODE_API_KEY_FILE_DESCRIPTOR',
